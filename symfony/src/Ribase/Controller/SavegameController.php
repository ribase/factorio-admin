...
class SavegameController extends Controller
{
     ...
     * @Route("/savegames", name="Savegames")
     */
    public function listAction(Request $request)
    {
        $path = $this->getSavegameDir();
        $finder = new Finder();
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isSubmitted()) {
                ...
                return $this->redirect('/savegames', 301);
            }
        }

        $response = $this->render('admin/savegame.html.twig', array(
            'view' => $fileNames,
     ...
     * @return string
     */
    private function getSavegameDir()
    {
        $settings = new Settings();

        return $settings->getSaves();
    }
}